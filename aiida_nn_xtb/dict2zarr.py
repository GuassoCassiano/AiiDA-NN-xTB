...
def build_openqdc_zarr(target_group="rough_draft_testing"):
    ...
    root.create_dataset('positions', data=np.array(all_positions, dtype=object))
    root.create_dataset('atomic_numbers', data=np.array(all_atomic_numbers, dtype=object))
